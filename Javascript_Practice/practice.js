const result = function checkNumber (a,b){
...
//console.log(result(100,10));

// OR using arrow function

const result1 = (a,b) =>  a == 100 || b == 100 || (a+b) == 100;
  
//console.log(result1(10,90));
...
const dateRes =function getCurrentDate() {
const date = new Date();
let month, year;
month = date.getMonth();
...
//console.log(addString("Sati"));

//OR

const addString1 = (str)=> str.indexOf("New!") === 0 ? str : `New! ${str}`
//console.log(addString1("New! Swati"));
...
if (str.length < 3){
    ...
    firstString = str.substring(0,3);
    console.log(firstString);
    lastString = str.slice(-3)
    console.log(lastString);
    console.log(firstString + lastString);
}
}

createNewString("abcd is my name");

//OR

const createNewStr = (str) => str.length < 3 ? str : str.substring(0,3) + str.slice(-3);
//console.log(createNewStr('abc def is my name'));

const evenLenght = (str) => str.length % 2 ===0 ? str.substring(0,str.length/2) : str;
console.log(evenLenght('swati sharma'));
...
const findNearestToHundred = (num1,num2) => 100 - num1 < 100 - num2 ? num1 : num2;
console.log(findNearestToHundred(70,90));

let Count = [];
function checkOccurence(str,character){
    ...
    console.log(Count);
 const result = Count[character] >= 2 && Count[character] <=4 ? true : false;
 console.log(result);
}
 
//checkOccurence("Hello dear","l");


//OR

const countChar = (str,char) =>str.split('').filter(ch => ch === char).length;
const containsChar = (str,char) => countChar(str,char) >= 2 && countChar(str,char) <= 4 ;
...
//OR
const findEvenDigit12 = (arr) => arr.filter(num => num % 2 === 0 ? true : false);
...
// console.log(replaceFirstDigit("res1tart"));
 ...
 const checkTwoObjects = (obj1,obj2)=>Object.keys(obj1).every(key => obj2[key]);
 

console.log(checkTwoObjects({name:"Swati",age:25},{name:"Sharma",age:30}));
...
function generateRandomHexColor() {
 ...
 const getHexcolor = () => '#' + Array.from({length: 6}).map(generateRandomHexColor).join('');
